            ...
            >
                ...
                <div class="flex justify-between">
                    <router-link
                        ...
                        class="flex py-2 px-4 border border-transparent text-sm rounded-md text-indigo-500 hover:bg-indigo-700 hover:text-white transition-colors focus:rin-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                        <svg
