        ...
        <div class="flex justify-between items-center mt-3">
            ...
            <div class="flex items-center  ">
                <a
                    ...
                    target="_blank"
                    class="h-8 w-8 flex items-center justity-center rounded-full border border-transparent text-sm text-indigo-500 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                ...
                <button
                    ...
                    class="flex h-8 w-8 border border-transparent items-center justify-center text-sm rounded-full text-black focus:ring-2 focus:ring-offset-2 focus:ring-grey-900"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
